...
int GFX_getButtonGroupWidth(char** hints, int primary);
int GFX_blitButtonGroupAt(char** hints, int primary, SDL_Surface* dst, int ox); // draw at an explicit x
int GFX_blitButtonGroup(char** hints, int primary, SDL_Surface* dst, int align_right); // align_right: 0=left, 1=right, 2=center
